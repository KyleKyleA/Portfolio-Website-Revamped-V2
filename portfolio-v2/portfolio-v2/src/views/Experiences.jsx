...
function Experiences() {
    ...
    return (
        <>
            <h2 className="mb-4 text-4xl font-bold tracking-tight text-heading md:text-5xl lg:text-6xl-centered">Experiences</h2>
            ...
            <ol className="items-center sm:flex">
                ...
                <time className="bg-neutral-secondary-medium border border-default-medium text-heading text-xs font-medium px-1.5 py-0.5 rounded-centered">March 21st 2026</time>
                <h3 className="text-lg font-semibold text-heading my-2 right-centered">PaceField | Software Developer </h3>
                </div>
